...
# Adaption for ntel by George McCollister
...
#
# For further changes consult 'git log'
...
function update_oe()
{
    ...
    #manage meta-openembedded and meta-ntel with layerman
...
echo "       qemux86-64:          Emulated x86-64 machine"
echo ""
